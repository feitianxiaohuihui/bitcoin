...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 210000;   // TFF-- 区块奖励减半间隔
        ...
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");  // TFF-- 算力极限值
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks // TFF-- 挖矿难度调整时间
